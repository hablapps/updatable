...
class AtBuilderClassTest extends FunSpec with ShouldMatchers {
  ...
  @builder abstract class E { val e_1: Int }

  @builder abstract class E1 extends E
  ...
  @weakBuilder abstract class G {
    type GType
    implicit def ev: MyEvidence[GType]
  }

  @builder abstract class G1 extends G {
    type GType = Int
  ...
  @builder abstract class G2 extends G {
    type GType = Int
    type G2Type = G1
  ...
  @weakBuilder abstract class H {
    type New
    implicit def ev1: Builder[New]
  }

  @builder abstract class H1 extends H {
    type New = G1
  }

  @builder abstract class J {
  ...
  @builder abstract class J1 extends J

  @builder abstract class K {
    type ContextCol_Default[x] = List[x]
    type ContextCol[_]
  ...
  @builder abstract class K1 extends K {
  ...
  @weakBuilder abstract class L1 extends L {
    type Context <: Int
  }

  @builder abstract class L11 extends L1
  ...
  @builder abstract class O1 extends O {
    val a2: Option[T]
  }
  ...
  @builder abstract class P1 extends P {
    type U = T
